...
cd URDFs
# test -f "$1~/interbotix_ws/src/interbotix_ros_arms/interbotix_descriptions/urdf/rx200.urdf.xacro"
cp rx200.urdf.xacro ~/interbotix_ws/src/interbotix_ros_arms/interbotix_descriptions/urdf/rx200.urdf.xacro
rosrun xacro xacro ~/interbotix_ws/src/interbotix_ros_arms/interbotix_descriptions/urdf/rx200.urdf.xacro > robot.urdf
